test_with_student: test_list_with_student_struct.c src/my_list.c src/output_helpers.c
	gcc -o test_with_student_struct test_list_with_student_struct.c src/my_list.c src/output_helpers.c
...
all: test_at_head test_at_tail test_at_pos test_with_student